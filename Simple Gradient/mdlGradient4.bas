Attribute VB_Name = "mdlGradient4"
...
Dim grdByteVert(7)  As Byte
    ...
    If gType = Fill_None Then Exit Function
    If gType = Fill_Horizontal Then gWidth = gWidth / (gRepeat + 1) Else gHeight = gHeight / (gRepeat + 1)
    ...
    If gType = Fill_Vertical Then gY = gY + gHeight Else gX = gX + gWidth
